...
BOOL T_Engine::GameWinInit()
{
	...
	// 2021-12-19 修改：
	// 窗口风格：WS_OVERLAPPEDWINDOW=WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_THICKFRAME | WS_MINIMIZEBOX | WS_MAXIMIZEBOX
	// WS_THICKFRAME(窗口宽边框风格)要去掉，否则会自动生成多余的空间
	AdjustWindowRect(&ClientRegion, WS_OVERLAPPEDWINDOW & ~WS_THICKFRAME, FALSE);
